            ...
            {[...Array(8)].map((_, i) => (
              ...
              >
                <div className="text-center">
                  <div className="w-40 h-24 bg-muted rounded-lg mb-3 mx-auto flex items-center justify-center">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          {partners.map((partner) => (
            ...
            >
              <div className="text-center">
                {partner.fields.logo ? (
                  <div className="w-40 h-24 bg-muted rounded-lg mb-3 mx-auto flex items-center justify-center overflow-hidden">
                    <img
